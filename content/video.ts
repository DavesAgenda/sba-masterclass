...
export const lessonClips: Record<string, LessonClip> = {
  tools: {
    title: "Meet the three tools", shareId: "tWPDahjdeDb", youtubeId: "JCb6RpqFiyc", sourceTime: "09:24–10:59", duration: "1:35",
    summary: "Dave introduces the agent, GitHub and hosting: the tools used to take an idea to a website you control.",
  },
  prompt: {
    title: "Turn your design into a build brief", shareId: "6uwKLhaDA0c", youtubeId: "BiTOB8BQ0T0", sourceTime: "36:00–40:33", duration: "4:33",
  ...
  github: {
    title: "Let Codex save your site to GitHub", shareId: "wLr1wbym39L", youtubeId: "RVzdG-Z45Ks", sourceTime: "1:34:11–1:39:22", duration: "5:11",
  ...
  deploy: {
    title: "Publish your site with Vercel", shareId: "kbZvjXWI0b7", youtubeId: "ZMiHiEFg6t0", sourceTime: "1:39:46–1:41:35", duration: "1:49",
    summary: "Sign in with GitHub, import the site, and select Deploy. Then open the new website address.",
  },
  domain: {
    title: "Connect your domain", shareId: "69c2nhnUKkY", youtubeId: "9lyS5CL52Xc", sourceTime: "1:44:26–1:47:36", duration: "3:11",
  ...
  updates: {
    title: "Review changes and make them live", shareId: "d2uWhouGedA", youtubeId: "ND7jYHCNRJM", sourceTime: "2:08:10–2:11:03", duration: "2:54",
